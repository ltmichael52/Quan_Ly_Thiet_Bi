...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=MHUNG\\SQLEXPRESS;Initial Catalog=QLTHIETBI;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Chitietphieumuon>(entity =>
        {
            entity.HasKey(e => e.Mactpm).HasName("PK__CHITIETP__F50D75CA51DA8B28");
        ...
        {
            entity.HasKey(e => e.Macs).HasName("PK__COSO__603F183BED1C350F");
        ...
        {
            entity.HasKey(e => e.Manv).HasName("PK__NHANVIEN__603F5114894AC6CF");
        ...
        {
            entity.HasKey(e => e.Map).HasName("PK__PHONG__C7907780ED66A93B");
        ...
        {
            entity.HasKey(e => e.Masv).HasName("PK__SINHVIEN__60228A2838C40CEB");
        ...
        {
            entity.HasKey(e => e.Matb).HasName("PK__THIETBI__6023721DD1D4DC00");
