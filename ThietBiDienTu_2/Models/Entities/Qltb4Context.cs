...
public partial class Qltb4Context : DbContext
{
    public Qltb4Context()
    {
    }

    public Qltb4Context(DbContextOptions<Qltb4Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-NF8GFOC\\SQLSERVER2022DEV;Initial Catalog=QLTB4;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Dongthietbi>(entity =>
        {
            ...
            entity.Property(e => e.Soluonghoatdong).HasColumnName("SOLUONGHOATDONG");
        ...
        modelBuilder.Entity<Phieumuon>(entity =>
        {
            ...
            entity.Property(e => e.Ngaymuon)
                .HasDefaultValueSql("('1990-01-01T00:00:00.000')")
                .HasColumnType("datetime")
